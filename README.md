...
Smithery CLI connects your agents to thousands of skills and MCP servers from [Smithery](https://smithery.ai) directly through the command line. To get started, simply run `npx skills add smithery/cli` and ask your agent to explore skills and connect to MCP servers.
